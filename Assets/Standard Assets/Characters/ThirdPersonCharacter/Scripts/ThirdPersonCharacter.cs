...
namespace UnityStandardAssets.Characters.ThirdPerson
{
	...
	public class ThirdPersonCharacter : MonoBehaviour
	{
		...
		[SerializeField] float m_RunCycleLegOffset; //specific to the character in sample assets, will need to be modified to work with others
		...
		public void Move(Vector3 move, bool run, bool crouch, bool jump)
		{
            ...
            if (!run) {
                move.Scale(new Vector3(k_Half, k_Half, k_Half));
            }
